...
(function (global) {
    ...
    global.soupMenu = {
        ...
        syncUi() {
            ...
            if (b.pct > 0 && b.dish) {
                const rest = t('menu_chip', { dish: b.dish, pct: b.pct }).replace(/^🍲\s*/, '');
                const html = (typeof scCauldronIcon !== 'undefined') ? scCauldronIcon.prefixText(rest) : t('menu_chip', { dish: b.dish, pct: b.pct });
